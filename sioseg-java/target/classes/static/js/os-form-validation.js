...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('change', function(e) {
        if (e.target.id && e.target.id.startsWith('quantidade')) {
            var input = e.target;
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            var quantidadeInputs = document.querySelectorAll('input[type="number"][id*="quantidade"]');
            var hasError = false;
    ...
    document.addEventListener('change', function(e) {
        if (e.target.id && e.target.id.startsWith('produto')) {
            var select = e.target;
